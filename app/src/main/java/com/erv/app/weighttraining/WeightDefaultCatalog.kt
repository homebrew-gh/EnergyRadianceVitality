...
internal fun builtinCatalogBeyondCompounds(): List<WeightExercise> = listOf(
    ...
    // —— Bodyweight ——
    WeightExercise(id = "erv-weight-exercise-bw-pushup-v1", name = "Push-Up", muscleGroup = "chest", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-pike-pushup-v1", name = "Pike Push-Up", muscleGroup = "shoulders", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-air-squat-v1", name = "Air Squat", muscleGroup = "legs", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-reverse-lunge-v1", name = "Bodyweight Reverse Lunge", muscleGroup = "legs", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-glute-bridge-v1", name = "Glute Bridge", muscleGroup = "legs", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-situp-v1", name = "Sit-Up", muscleGroup = "core", pushOrPull = WeightPushPull.PULL, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-crunch-v1", name = "Crunch", muscleGroup = "core", pushOrPull = WeightPushPull.PULL, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-plank-v1", name = "Plank", muscleGroup = "core", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-side-plank-v1", name = "Side Plank", muscleGroup = "core", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-superman-v1", name = "Superman", muscleGroup = "back", pushOrPull = WeightPushPull.PULL, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-mountain-climber-v1", name = "Mountain Climber", muscleGroup = "core", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    WeightExercise(id = "erv-weight-exercise-bw-burpee-v1", name = "Burpee", muscleGroup = "legs", pushOrPull = WeightPushPull.PUSH, equipment = WeightEquipment.OTHER),
    ...
    // —— Specialty packs ——
    WeightExercise(
        id = "erv-weight-exercise-in-iron-neck-flexion-v1",
    ...
    WeightExercise(
        id = "erv-weight-exercise-in-iron-neck-extension-v1",
        name = "Iron Neck Extension",
        muscleGroup = "neck",
    ...
    WeightExercise(
        id = "erv-weight-exercise-in-iron-neck-left-lateral-flexion-v1",
        name = "Iron Neck Left Lateral Flexion",
        muscleGroup = "neck",
        pushOrPull = WeightPushPull.PUSH,
        equipment = WeightEquipment.OTHER,
        exercisePackId = IRON_NECK_EXERCISE_PACK_ID,
    ...
    WeightExercise(
        id = "erv-weight-exercise-in-iron-neck-right-lateral-flexion-v1",
        name = "Iron Neck Right Lateral Flexion",
        muscleGroup = "neck",
        pushOrPull = WeightPushPull.PUSH,
        equipment = WeightEquipment.OTHER,
        exercisePackId = IRON_NECK_EXERCISE_PACK_ID,
    ...
    WeightExercise(
        id = "erv-weight-exercise-in-iron-neck-left-rotation-v1",
        name = "Iron Neck Left Rotation",
        muscleGroup = "neck",
        pushOrPull = WeightPushPull.PULL,
        equipment = WeightEquipment.OTHER,
        exercisePackId = IRON_NECK_EXERCISE_PACK_ID,
    ...
    WeightExercise(
        id = "erv-weight-exercise-in-iron-neck-right-rotation-v1",
        name = "Iron Neck Right Rotation",
        muscleGroup = "neck",
        pushOrPull = WeightPushPull.PULL,
        equipment = WeightEquipment.OTHER,
        exercisePackId = IRON_NECK_EXERCISE_PACK_ID,
    ...
    WeightExercise(
        id = "erv-weight-exercise-fahp-reverse-hyper-v1",
        name = "Reverse Hyper",
        muscleGroup = "legs",
        pushOrPull = WeightPushPull.PULL,
        equipment = WeightEquipment.OTHER,
    ...
    WeightExercise(
        id = "erv-weight-exercise-fahp-45-degree-back-extension-v1",
    ...
    WeightExercise(
        id = "erv-weight-exercise-fahp-ghd-situp-v1",
        name = "GHD Sit-Up",
        muscleGroup = "core",
        pushOrPull = WeightPushPull.PULL,
        equipment = WeightEquipment.OTHER,
    ...
    WeightExercise(
        id = "erv-weight-exercise-fahp-nordic-curl-v1",
        name = "Nordic Curl",
        muscleGroup = "legs",
        pushOrPull = WeightPushPull.PULL,
        equipment = WeightEquipment.OTHER,
    ...
    WeightExercise(
        id = "erv-weight-exercise-fahp-glute-ham-raise-v1",
